 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sat Oct 22 21:36:54 2022
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                my_s_fun_withbuilder
...
extern void my_s_fun_withbuilder_Outputs_wrapper(const real_T *u0,
  const real_T *u1,
  real_T *y0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  my_s_fun_withbuilder_Outputs_wrapper(u0, u1, y0);
}
